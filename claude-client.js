          ...
          payload: {
            ...
            messages: [{
              ...
              content: [{
                ...
                type: 'text',
                text: 'Analyse cette facture energie. Le fournisseur est le vendeur (pas ENEDIS). Reponds UNIQUEMENT en JSON sur une seule ligne sans saut de ligne: {"fournisseur":"","pdl":"","periode":"","date_fin_contrat":"","montant_ht":0,"montant_ttc":0,"consommation_kwh":0,"prix_kwh":0,"puissance_kva":0,"cout_abonnement":0,"cout_energie":0,"cout_taxes":0,"emissions_co2":0,"anomalies":[]}'
              }]
            }]
          }
        })
